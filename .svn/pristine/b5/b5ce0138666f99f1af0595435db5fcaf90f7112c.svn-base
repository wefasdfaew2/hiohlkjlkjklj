...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        enableHomePageBottomBanner: true, //show banner from Wordpress instead Tournaments
        enableClassicScrollToggle: true,
        enableLiveSectionPin: true,
        mobileVersionLink: "http://mobile.vbet.com",
        liveModule: {
            enabled: true,
            url: "http://livemodule.vbet.com",
            skin: "vbet.com"
        },
        showNewsInClassicView: true,
        availableSportsbookViews: {modern: true, classic: true, asian: true, external: true},
        asianLoadDays: 0,
        ...
        trackingScripts: [
            {
                ...
                dialog: {
                    ...
                    content: 'ACCUMULATOR<br />BONUS',
                    type: 'dialog',
                    image: 'images/dialog/version-4.png',
                    buttonText: 'Join Now',
            ...
            },
            {
                ...
                dialog: {
                    title: 'Our Promotions',
                    content: 'HAPPY<br />HOURS',
                    type: 'dialog',
                    image: 'images/dialog/version-5.png',
                    buttonText: 'Join Now',
                    buttonBroadcast: 'openRegForm'
                    //buttonURL: 'http://affiliates.vbet.com'
                }
        ...
        theVeryTopMenu: [{href: "#/promos/", label: "Promotions"}, {href: "#/fantasy/", label: "Fantasy Sports"}, {href: '#/financials/', label: "Financials"},  {href: "#/freebet/", label: "Free Quiz"}, {href: "#/jackpot/", label: "Jackpot"}],
        ...
        availableCurrencies: ['USD', 'EUR', 'RUB', 'UAH', 'CNY'],
        ...
        vkontakteUrl: "https://vk.com/clubvbet",
        instagramUserName: "vbet_official",
        twitterAccount: 'Vbet_com',
        twitterHashTag: 'vbet'
    },
    customTemplates: ["landing/main.html",  "footer.html"],
    regConfig: {
        "rightCol": [{
            "title": "Country",
            "name": "country_id",
    ...
    poker: {
        ...
        instantPlayLink: 'http://vbet-poker.betconstruct.com/flashclient/',
        instantPlayTarget: '',
        downloadLink: {
            '@replace': true,
            windows: 'http://vbet-poker.betconstruct.com/downloadFile.php?do=xp',
    ...
    xDomainSlaves: '{"https://swarm.vbet.com" : "/xdomain-proxy.html", "https://casino.vbet.com" : "/global/partners/xdomain/xDomainProxy.html"}',
    'payments': [
        {
            name: 'skrill1tap',
            info: {
...
CMS.constant('SkinWPConfig', {
    ...
    wpUrl: 'https://www.vbet.com/json',  // WordpResss instance serving pages, banners
    wpNewsUrl:  {
        main: 'https://www.vbet.com/json'
