...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        menuOrder: ['live', 'sport', 'virtual-sports', 'belote', 'backgammon', 'virtual-betting', 'casino', 'poolbetting', 'poker', 'livedealer', 'games'],
        availableLanguages: {
    ...
    'swarm': {
        ...
        //url: [{url: "http://10.32.5.77:8080"}],
        //websocket: [{url: "wss://10.32.5.77:8080/"}]
    },
    poker: {
