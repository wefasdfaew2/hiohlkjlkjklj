...
VBET5.constant('SkinConfig', {
    'main': {
        siteTitle: {
            "eng": "terminal.starbetkaz.com",
            "rus": "terminal.starbetkaz.com"
        },
        site_name: "terminal.starbetkaz.com",
        site_id: 99,
        skin: 'terminal.starbetkaz.com',
        casinoEnabled: false,
        pokerEnabled: false,
        ...
        redirectOnTablets: 'http://tablet.terminal.starbetkaz.com/',
        videoEnabled: false,
        'rfid': {
            loginWIthRFID: true,
        ...
        about_company_text: {
            'eng' : "(c) terminal.starbetkaz.com",
            'rus' : "(c) terminal.starbetkaz.com"
        },
        availableLanguages: {
...
//    wpUrl: 'http://www.terminal.starbetkaz.com/json',  // WordpResss instance serving pages, banners
//    wpBaseHost: 'www.terminal.starbetkaz.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//    wpNewsUrl: 'http://www.terminal.starbetkaz.com/newsjson',  // WordpResss instance serving news
