...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        redirectOnTablets: 'http://tablet.rotabet.com/',
        videoEnabled: false,
        about_company_text: {
            'eng' : "(c) rotabet.com"
        },
...
//   wpUrl: 'http://www.rotabet.com/json',  // WordpResss instance serving pages, banners
//  wpBaseHost: 'www.rotabet.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//  wpNewsUrl: 'http://www.rotabet.com/newsjson',  // WordpResss instance serving news
...
CASINO.constant('SkinCConfig', {
    cUrlPrefix: 'http://games.rotabet.com',
