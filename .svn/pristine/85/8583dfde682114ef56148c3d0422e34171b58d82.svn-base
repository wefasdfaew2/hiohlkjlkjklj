...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        redirectOnTablets: 'http://tablet.esbet.com/',
        videoEnabled: false,
        about_company_text: {
            'eng' : "(c) esbet.com"
        },
...
//   wpUrl: 'http://www.esbet.com/json',  // WordpResss instance serving pages, banners
//  wpBaseHost: 'www.esbet.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//  wpNewsUrl: 'http://www.esbet.com/newsjson',  // WordpResss instance serving news
...
CASINO.constant('SkinCConfig', {
    cUrlPrefix: 'http://games.esbet.com',
