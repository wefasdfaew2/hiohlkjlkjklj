...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        ogwilEnabled: true,
        enableBonusSectionInWallet: false,
        redirectOnTablets: 'http://tablet.marsbet.com/',
        videoEnabled: false,
        about_company_text: {
            'eng' : "(c) marsbet.com"
        },
        ...
        liveChat: {
			customDivId: 'LP_DIV_1437162328988'
			//isSfChat:true,
            //siteId: 32814,
            //codePlan: 357
        },
...
//   wpUrl: 'http://www.marsbet.com/json',  // WordpResss instance serving pages, banners
//  wpBaseHost: 'www.marsbet.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//  wpNewsUrl: 'http://www.marsbet.com/newsjson',  // WordpResss instance serving news
...
CASINO.constant('SkinCConfig', {
    cUrlPrefix: 'http://games.marsbet.com',
