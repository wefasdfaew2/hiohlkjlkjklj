...
VBET5.constant('SkinConfig', {
    ...
    customTemplates: ["landing/main.html"],
    regConfig: {
        "rightCol": [{
            "title": "Country",
            "name": "country_id",
    ...
    'swarm': {
        ...
        url: [{url: "http://swarm2.betconstruct.com:8950/"}],
        websocket: [{url: "ws://swarm2.betconstruct.com:8950/"}]
    },
    poker: {
    ...
    xDomainSlaves: '{"http://swarm2.betconstruct.com:8950" : "/xdomain-proxy.html", "http://casino.vbet.com" : "/global/partners/xdomain/xDomainProxy.html"}',
    'payments': [
        {
            name: 'skrill1tap',
            info: {
...
CASINO.constant('SkinCConfig', {
    cUrlPrefix: 'http://casino.spring.betconstruct.am',
