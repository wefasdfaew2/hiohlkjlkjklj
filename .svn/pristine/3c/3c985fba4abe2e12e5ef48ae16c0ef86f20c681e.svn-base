 ...
 */
VBET5.controller('OdnoklassnikiCtrl', ['$scope', '$window', '$rootScope', '$timeout', 'Config', 'Zergling', 'Storage', function ($scope, $window, $rootScope, $timeout, Config, Zergling, Storage) {
    var data,
        width = 520,
        height = 400,
