...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        menuOrder: ['live', 'sport', 'livemodule-sport', 'livemodule-live',  'livecalendar', 'virtual-sports', 'belote', 'backgammon', 'games', 'virtual-betting', 'casino', 'poolbetting', 'poker',  'livedealer', 'ogwil', 'freebet', 'fantasy', 'jackpot', 'financials'],
        newMenuItems: {liveCasino: true},
        useAuthCookies: true,
        enableBetBooking: true,
        bookingBetPrintViewType: 2,
