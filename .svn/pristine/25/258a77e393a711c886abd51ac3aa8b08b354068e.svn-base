 ...
 */
VBET5.controller('myGamesCtrl', ['$scope', '$rootScope', '$location', '$route', 'Utils', 'Storage', 'Zergling', 'Config', 'GameInfo', function ($scope, $rootScope, $location, $route, Utils, Storage, Zergling, Config, GameInfo) {
    'use strict';
    ...
    $scope.gotoGame = function gotoGame(game) {
        ...
        $location.search({
            'game' : game.id,
            'sport': (Config.main.showFavoriteGamesInSportList && Config.main.sportsLayout !== "classic") ? -1 : game.sport.id,
