 ...
 */
   ...
   *                      his mouse pointer.
   */
  VBET5.directive('dndDraggable', ['$parse', '$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround',
    ...
    return function(scope, element, attr) {
      ...
      element.on('dragend', function(event) {
        event = event.originalEvent || event;
        $parse(attr.dndEnd)(scope, {event: event});
      ...
      element.on('dragover', function(event) {
        ...
        if (event.target !== listNode) {
          ...
          if (listItemNode.parentNode === listNode && listItemNode !== placeholderNode) {
            ...
            if(!isMouseInFirstHalf(event, listItemNode) || (listItemNode && listItemNode.previousSibling && listItemNode.previousSibling.attributes
                && listItemNode.previousSibling.attributes["class"] && "dndPlaceholder" === listItemNode.previousSibling.attributes["class"].value)) {
