...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        ogwilEnabled: true,
        redirectOnTablets: 'http://tablet.kozbet.com/',
        videoEnabled: false,
        about_company_text: {
            'eng' : "(c) kozbet.com"
        },
...
//   wpUrl: 'http://www.kozbet.com/json',  // WordpResss instance serving pages, banners
//  wpBaseHost: 'www.kozbet.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//  wpNewsUrl: 'http://www.kozbet.com/newsjson',  // WordpResss instance serving news
...
CASINO.constant('SkinCConfig', {
    cUrlPrefix: 'http://games.kozbet.com',
