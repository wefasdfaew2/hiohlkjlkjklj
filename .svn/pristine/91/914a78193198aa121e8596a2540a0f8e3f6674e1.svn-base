...
/**
 * @ngdoc controller
 * @name vbet5.controller:pageSliderCtrl
 * @description
 */
VBET5.controller('pageSliderCtrl', ['$scope', '$location', '$sce', 'content', function ($scope, $location, $sce, content) {
    'use strict';
     ...
     * @methodOf vbet5.controller:pageSliderCtrl
