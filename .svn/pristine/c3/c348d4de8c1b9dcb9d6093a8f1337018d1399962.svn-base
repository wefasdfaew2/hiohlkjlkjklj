...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        redirectOnTablets: 'http://tablet.betkid.com/',
        videoEnabled: false,
        about_company_text: {
            'eng' : "(c) betkid.com"
        },
...
//   wpUrl: 'http://www.betkid.com/json',  // WordpResss instance serving pages, banners
//  wpBaseHost: 'www.betkid.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//  wpNewsUrl: 'http://www.betkid.com/newsjson',  // WordpResss instance serving news
...
CASINO.constant('SkinCConfig', {
    cUrlPrefix: 'http://games.betkid.com',
