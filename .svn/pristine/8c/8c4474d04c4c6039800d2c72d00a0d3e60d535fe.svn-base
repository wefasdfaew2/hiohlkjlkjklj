...
VBET5.constant('SkinConfig', {
    ...
    'swarm': {
        url: [{ url: "https://swarm.betsking.com:8085/"}],
        websocket: [{ url: "wss://swarm.betsking.com:8085/"}]
    },
    xDomainSlaves: '{"https://swarm.betsking.com:8085" : "/xdomain-proxy.html"}', //has to be JSON string
...
CMS.constant('SkinWPConfig', {
    wpUrl: 'http://sportsbook.betsking.com/json', // WordpResss instance serving pages, banners
    wpBaseHost: 'http://sportsbook.betsking.com'  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
