...
VBET5.constant('SkinConfig', {
    'main': {
        siteTitle: {
            "eng": "terminal.melbet.com",
            "rus": "terminal.melbet.com"
        },
        site_name: "terminal.melbet.com",
        site_id: null, //"18",
        skin: 'terminal.melbet.com',
        casinoEnabled: false,
        pokerEnabled: false,
        ...
        redirectOnTablets: 'http://tablet.terminal.melbet.com/',
        videoEnabled: false,
        'rfid': {
            loginWIthRFID: true,
        ...
        about_company_text: {
            'eng' : "(c) terminal.melbet.com",
            'rus' : "(c) terminal.melbet.com"
        },
        availableLanguages: {
