 ...
 *  freeBet controller.
 */
VBET5.controller('freeBetCtrl', ['$scope', '$rootScope', 'Utils', 'Zergling', 'Moment', 'Translator', function ($scope, $rootScope, Utils, Zergling, Moment, Translator) {
    'use strict';
    ...
    $scope.creatDays = function () {
        $scope.days = [];
        var today;
        angular.forEach([0, 1, 2, 3], function (offset) {
     ...
     * @description
     */
    $scope.doFreeBet = function doFreeBet(victorinaId) {
        var selections = [];
