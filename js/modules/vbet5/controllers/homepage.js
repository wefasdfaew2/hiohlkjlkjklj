 ...
 */
angular.module('vbet5.betting').controller('homepageCtrl', ['$rootScope', '$scope', '$interval', '$location', 'analytics', 'Zergling', 'Utils', 'Moment', 'Config', 'WPConfig', 'content', function ($rootScope, $scope, $interval, $location, analytics, Zergling, Utils, Moment, Config, WPConfig, content) {
    'use strict';
    ...
    $scope.getHomepageRightBanners = function getHomepageRightBanners(containerId) {
        ...
        containerId = containerId || WPConfig.bannerSlugs.homepageRightBanners[$rootScope.env.lang];
