 ...
 */
VBET5.service('DomHelper', ['$window', '$timeout', function ($window, $timeout) {
    'use strict';
    ...
    DomHelper.onContentheightChange = function onContentheightChange(callback, interval) {
        ...
        $window.setInterval(function () {
            if ($window.document.body.scrollHeight !== scrollHeight) {
                scrollHeight = $window.document.body.scrollHeight;
                callback(scrollHeight, $window.document.body.scrollWidth);
            }
        }, interval);
    ...
    DomHelper.onBodyHeightChange = function onBodyHeightChange(callback, interval) {
        ...
        var offsetHeight;
        $window.setInterval(function () {
            if ($window.document.body.offsetHeight !== offsetHeight) {
