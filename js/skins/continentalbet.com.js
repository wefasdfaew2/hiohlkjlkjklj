...
VBET5.constant('SkinConfig', {
    'main': {
        siteTitle: {
            "eng": "continentalbet.com"
        },
        site_name: "continentalbet.com",
        site_id: "13",
        skin: 'continentalbet.com',
        casinoEnabled: true,
        pokerEnabled: true,
        liveDealerEnabled: false,
        financialsEnabled: false,
        skillgamesEnabled: true,
        redirectOnTablets: 'http://tablet.continentalbet.com/',
        videoEnabled: false,
        about_company_text: {
            'eng' : "(c) continentalbet.com"
        },
        availableLanguages: {
...
//   wpUrl: 'http://www.continentalbet.com/json',  // WordpResss instance serving pages, banners
//  wpBaseHost: 'www.continentalbet.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//  wpNewsUrl: 'http://www.continentalbet.com/newsjson',  // WordpResss instance serving news
...
CASINO.constant('SkinCConfig', {
    cUrlPrefix: 'http://games.continentalbet.com',
