...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        redirectOnTablets: 'http://tablet.bbet.com/',
        videoEnabled: true,
        about_company_text: {
    ...
    backgammon: {
        instantPlayLink: 'http://backgammon.bbet.com',
        downloadLink: {
            windows: 'http://games.bbet.com/nardi/JustinGammon-1.1.24-Setup.exe'
        }
    },
    'payments': [
        {
...
CMS.constant('SkinWPConfig', {
    wpUrl: 'http://www.bbet.com/json',  // WordpResss instance serving pages, banners
    wpBaseHost: 'www.bbet.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
...
CASINO.constant('SkinCConfig', {
    cUrlPrefix: 'http://games.bbet.com',
