...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        about_company_text: {
            'eng' : "(c) betmaximum.com",
            'rus' : "(c) betmaximum.com"
        },
        availableLanguages: {
    ...
    'swarm': {
        url: [{ url: "https://swarm.betmaximum.com:8085/"}],
        websocket: [{ url: "wss://swarm.betmaximum.com:8085/"}]
    },
    xDomainSlaves: '{"https://swarm.betmaximum.com:8085" : "/xdomain-proxy.html"}', //has to be JSON string
...
CMS.constant('SkinWPConfig', {
    wpUrl: 'http://sportsbook.betmaximum.com/json', // WordpResss instance serving pages, banners
    wpBaseHost: 'http://sportsbook.betmaximum.com'  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
