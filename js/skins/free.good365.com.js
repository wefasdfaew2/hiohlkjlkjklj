...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        site_name: "free.good365.com",
        skin: 'free.good365.com',
...
CMS.constant('SkinWPConfig', {
    wpUrl: 'http://free.good365.com/json',  // WordpResss instance serving pages, banners
    wpNewsUrl: {
        main: 'http://www.vbet.com/json'
    },  // WordpResss instance serving news
    wpBaseHost: 'free.good365.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host
...
CASINO.constant('SkinCConfig', {
    cUrlPrefix: 'http://games.free.good365.com',
