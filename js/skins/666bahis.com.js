...
VBET5.constant('SkinConfig', {
    ...
    'swarm': {
        url: [{ url: "https://swarm.666bahis.com:8085/"}],
        websocket: [{ url: "wss://swarm.666bahis.com:8085/"}]
    },
    xDomainSlaves: '{"https://swarm.666bahis.com:8085" : "/xdomain-proxy.html"}', //has to be JSON string
...
CMS.constant('SkinWPConfig', {
    wpUrl: 'http://sportsbook.666bahis.com/json', // WordpResss instance serving pages, banners
    wpBaseHost: 'http://sportsbook.666bahis.com'  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
