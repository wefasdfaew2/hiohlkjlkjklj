...
VBET5.constant('SkinConfig', {
    ...
    partner: {
        documentDomain: 'iconicbet.com',  // both parent and iframe have to set  window.document.domain = documentDomain for cross-subdomain JS to work
...
//    wpUrl: 'http://www.iconicbet.com/json',  // WordpResss instance serving pages, banners
//    wpBaseHost: 'www.iconicbet.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//    wpNewsUrl: 'http://www.iconicbet.com/newsjson',  // WordpResss instance serving news
