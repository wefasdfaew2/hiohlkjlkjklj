...
VBET5.constant('SkinConfig', {
    ...
    'swarm': {
        url: [{ url: "http://swarm.91dakika.com:8085/"}],
        websocket: [{ url: "ws://swarm.91dakika.com:8085/"}]
    },
    xDomainSlaves: '{"http://swarm.91dakika.com:8085" : "/xdomain-proxy.html"}', //has to be JSON string
...
//    wpUrl: 'http://www.90dakika.com/json',  // WordpResss instance serving pages, banners
//    wpBaseHost: 'www.90dakika.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//    wpNewsUrl: 'http://www.90dakika.com/newsjson',  // WordpResss instance serving news
