...
VBET5.constant('SkinConfig', {
    'main': {
        siteTitle: {
            "eng": "terminal.unionbet.com",
            "rus": "terminal.unionbet.com"
        },
        site_name: "terminal.unionbet.com",
        site_id: 47,
        skin: 'terminal.unionbet.com',
        casinoEnabled: false,
        pokerEnabled: false,
        ...
        redirectOnTablets: 'http://tablet.terminal.unionbet.com/',
        videoEnabled: false,
        'rfid': {
            loginWIthRFID: true,
        ...
        about_company_text: {
            'eng' : "(c) terminal.unionbet.com",
            'rus' : "(c) terminal.unionbet.com"
        },
        availableLanguages: {
...
//    wpUrl: 'http://www.terminal.unionbet.com/json',  // WordpResss instance serving pages, banners
//    wpBaseHost: 'www.terminal.unionbet.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//    wpNewsUrl: 'http://www.terminal.unionbet.com/newsjson',  // WordpResss instance serving news
