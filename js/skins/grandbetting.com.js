...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        site_name: "grandbetting.com",
        site_id: "13",
        skin: 'grandbetting.com',
        casinoEnabled: true,
        pokerEnabled: true,
        liveDealerEnabled: false,
        financialsEnabled: false,
        skillgamesEnabled: true,
        redirectOnTablets: 'http://tablet.grandbetting.com/',
        videoEnabled: false,
        about_company_text: {
            'eng' : "(c) grandbetting.com"
        },
        availableLanguages: {
...
//   wpUrl: 'http://www.grandbetting.com/json',  // WordpResss instance serving pages, banners
//  wpBaseHost: 'www.grandbetting.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//  wpNewsUrl: 'http://www.grandbetting.com/newsjson',  // WordpResss instance serving news
...
CASINO.constant('SkinCConfig', {
    cUrlPrefix: 'http://games.grandbetting.com',
