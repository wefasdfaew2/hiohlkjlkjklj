...
VBET5.constant('SkinConfig', {
    'main': {
        siteTitle: {
            "eng": "elcasinocaribe.net"
        },
        site_name: "elcasinocaribe.net",
        site_id: "117",
        skin: 'elcasinocaribe.net',
        casinoEnabled: true,
        pokerEnabled: true,
        liveDealerEnabled: true,
        financialsEnabled: false,
        skillgamesEnabled: true,
        redirectOnTablets: 'http://tablet.elcasinocaribe.net/',
        videoEnabled: false,
        about_company_text: {
            'eng' : "(c) elcasinocaribe.net"
        },
        availableLanguages: {
...
//   wpUrl: 'http://www.elcasinocaribe.net/json',  // WordpResss instance serving pages, banners
//  wpBaseHost: 'www.elcasinocaribe.net',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//  wpNewsUrl: 'http://www.elcasinocaribe.net/newsjson',  // WordpResss instance serving news
...
CASINO.constant('SkinCConfig', {
    cUrlPrefix: 'http://games.elcasinocaribe.net',
