...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        redirectOnTablets: 'http://tablet.betsat.com/',
        videoEnabled: false,
        about_company_text: {
            'eng' : "(c) betsat.com"
        },
        liveModule: {
            enabled: true,
            url: "http://livemodule.betsat.com",
            skin: "betsat.com"
        },
        menuOrder: ['livemodule-sport', 'livemodule-live',  'livecalendar', 'virtual-sports', 'belote', 'backgammon', 'virtual-betting', 'casino', 'poolbetting', 'poker',  'livedealer',  'games', 'ogwil', 'freebet', 'fantasy', 'jackpot', 'financials'],
        availableLanguages: {
...
//   wpUrl: 'http://www.betsat.com/json',  // WordpResss instance serving pages, banners
//  wpBaseHost: 'www.betsat.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//  wpNewsUrl: 'http://www.betsat.com/newsjson',  // WordpResss instance serving news
...
CASINO.constant('SkinCConfig', {
    cUrlPrefix: 'http://games.betsat.com',
