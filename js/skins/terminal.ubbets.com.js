...
VBET5.constant('SkinConfig', {
    'main': {
        siteTitle: {
            "eng": "terminal.ubbets.com",
            "rus": "terminal.ubbets.com"
        },
        site_name: "terminal.ubbets.com",
        site_id: 25,
        skin: 'terminal.ubbets.com',
        casinoEnabled: false,
        pokerEnabled: false,
        ...
        redirectOnTablets: 'http://tablet.terminal.ubbets.com/',
        videoEnabled: false,
        'rfid': {
            loginWIthRFID: true,
        ...
        about_company_text: {
            'eng' : "(c) terminal.ubbets.com",
            'rus' : "(c) terminal.ubbets.com"
        },
        availableLanguages: {
...
//    wpUrl: 'http://www.terminal.ubbets.com/json',  // WordpResss instance serving pages, banners
//    wpBaseHost: 'www.terminal.ubbets.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//    wpNewsUrl: 'http://www.terminal.ubbets.com/newsjson',  // WordpResss instance serving news
