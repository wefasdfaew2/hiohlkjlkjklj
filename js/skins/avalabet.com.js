...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        ogwilEnabled: true,
        redirectOnTablets: 'http://tablet.avalabet.com/',
        videoEnabled: false,
        about_company_text: {
            'eng' : "(c) avalabet.com"
        },
...
//   wpUrl: 'http://www.avalabet.com/json',  // WordpResss instance serving pages, banners
//  wpBaseHost: 'www.avalabet.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//  wpNewsUrl: 'http://www.avalabet.com/newsjson',  // WordpResss instance serving news
...
CASINO.constant('SkinCConfig', {
    cUrlPrefix: 'http://games.avalabet.com',
