...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        site_name: "kingbetting.com",
        site_id: "13",
        skin: 'kingbetting.com',
        casinoEnabled: true,
        pokerEnabled: true,
        liveDealerEnabled: false,
        financialsEnabled: false,
        skillgamesEnabled: true,
        redirectOnTablets: 'http://tablet.kingbetting.com/',
        videoEnabled: false,
        about_company_text: {
            'eng' : "(c) kingbetting.com"
        },
        availableLanguages: {
...
//   wpUrl: 'http://www.kingbetting.com/json',  // WordpResss instance serving pages, banners
//  wpBaseHost: 'www.kingbetting.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//  wpNewsUrl: 'http://www.kingbetting.com/newsjson',  // WordpResss instance serving news
...
CASINO.constant('SkinCConfig', {
    cUrlPrefix: 'http://games.kingbetting.com',
