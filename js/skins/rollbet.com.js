...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        redirectOnTablets: 'http://tablet.rollbet.com/',
        videoEnabled: false,
        about_company_text: {
            'eng' : "(c) rollbet.com"
        },
...
//   wpUrl: 'http://www.rollbet.com/json',  // WordpResss instance serving pages, banners
//  wpBaseHost: 'www.rollbet.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//  wpNewsUrl: 'http://www.rollbet.com/newsjson',  // WordpResss instance serving news
...
CASINO.constant('SkinCConfig', {
    cUrlPrefix: 'http://games.rollbet.com',
