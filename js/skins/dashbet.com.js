...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        redirectOnTablets: 'http://tablet.dashbet.com/',
        videoEnabled: false,
        about_company_text: {
            'eng' : "(c) dashbet.com"
        },
...
//   wpUrl: 'http://www.dashbet.com/json',  // WordpResss instance serving pages, banners
//  wpBaseHost: 'www.dashbet.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
//  wpNewsUrl: 'http://www.dashbet.com/newsjson',  // WordpResss instance serving news
...
CASINO.constant('SkinCConfig', {
    cUrlPrefix: 'http://casino.dashbet.com',
