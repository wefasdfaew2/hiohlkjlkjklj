...
VBET5.constant('SkinConfig', {
    'main': {
        ...
        redirectOnTablets: 'http://tablet.maxinbahis.com/',
        videoEnabled: false,
        poweredByInFooter: false,
        about_company_text: {
            'eng' : "(c) maxinbahis.com",
            'rus' : "(c) maxinbahis.com"
        },
        availableLanguages: {
...
CMS.constant('SkinWPConfig', {
    ...
    wpBaseHost: 'www.maxinbahis.com',  // this parameter will be passed to JSON api and all links in response(e.g. images) will have this host,
    wpNewsUrl: {
